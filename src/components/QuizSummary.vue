<template>
  ...
  <div>
    ...
    correctly. This took you <span class="highlight">{{ duration }}</span>
  </div>
  <br />
  <div>
    You <span :class="finishType">{{ finishType }}</span> this quiz with a final
    score of <span class="highlight">{{ score }}</span
    >.
  </div>
  <div class="questions-summary">
    ...
    <div v-for="question in questions" :key="question.question" class="spoiler">
      ...
      />
      <br />Difficulty: {{ question.difficulty }}, Points awarded:
